...
export class InitSchema1747128739875 implements MigrationInterface {
    name = 'InitSchema1747128739875'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "inverters" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "model" varchar NOT NULL, "plant_id" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_inverters" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "model" varchar NOT NULL, "plant_id" integer, CONSTRAINT "FK_ddfa9e7756ae602a5ec4559bf71" FOREIGN KEY ("plant_id") REFERENCES "plants" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
